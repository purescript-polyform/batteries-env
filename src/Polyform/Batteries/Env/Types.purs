...
fromValidator :: forall errs m i. Monad m => Key -> Batteries.Validator' m errs i ~> Validator m errs i
...
fromDual :: forall errs i m. Monad m => Key -> Batteries.Dual' m errs i ~> Dual m errs i
